    ...
    $('#story').click(function() {
        ...
        function msgLoop(i) {
            if (i < 50) {
                ...
                $(`p:nth-child(${i + 1})`).fadeIn('slow', function() {
                    // After the first line fades in, wait before fading out
                    setTimeout(() => {
                        $(`p:nth-child(${i + 1})`).fadeOut('slow', function() {
                            // If it's the last line, stop the loop
                            if (i + 1 === 50) {
                                $('.cake').fadeIn('fast');
                            } else {
